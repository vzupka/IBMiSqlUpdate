...
echo jar cvfm  IBMiSqlUpdate.jar  manifesIBMiSqlUpdate.txt  -C build/classes  update/U_MainWindow.class  -C build/classes  update -C build/classes locales
jar cvfm  IBMiSqlUpdate.jar  manifestIBMiSqlUpdate.txt  -C build/classes  update/U_MainWindow.class  -C build/classes  update -C build/classes locales
